...
const LINKS = [
    ...
    {
        title: "Resource",
        items: ["Update Profile", "Newsletter", "Events", "Help center"],
    },
];
...
const Footer = () => {
    ...
    return (
        <footer
            className=" w-full h-[190px] mt-10 "
                ...
                <div className=" grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
                    <div className="flex flex-col items-start">
                        ...
                        <div className="flex w-full flex-col items-center justify-center py-4 md:flex-row md:justify-between">
                            ...
                            >
                                &copy; {currentYear} <a href="https://material-tailwind.com/">CraftedCanvas</a>. All
                                Rights Reserved.
                            </Typography>
